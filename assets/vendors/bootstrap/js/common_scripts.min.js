 ...
 */ !(function (t, e) {
  ...
  let t = new Map(),
    e = {
      ...
      remove(e, i) {
        if (!t.has(e)) return;
        let s = t.get(e);
        s.delete(i), 0 === s.size && t.delete(e);
      },
    },
    i = 1e6,
    s = 1e3,
    ...
    l = (t) => {
      ...
      return n || r
        ? ((e = e.split(",")[0]),
          (i = i.split(",")[0]),
          (Number.parseFloat(e) + Number.parseFloat(i)) * s)
        : 0;
    },
    h = (t) => {
    ...
    _ = (t, e = [], i = t) => ("function" == typeof t ? t(...e) : i),
    x = (t, e, i = !0) => {
      if (!i) {
        _(t);
        return;
      ...
      let s = 5,
        ...
        o = !1,
        a = ({ target: i }) => {
          i === e && ((o = !0), e.removeEventListener(n, a), _(t));
        };
  ...
  function W(t, e, i, s) {
    ...
    for (let [r, o] of Object.entries(n))
      r.includes(s) && H(t, e, i, o.callable, o.delegationSelector);
  }
  function R(t) {
    return F[(t = t.replace(D, ""))] || t;
  }
  let q = {
    on(t, e, i, s) {
      N(t, e, i, s, !1);
    ...
    off(t, e, i, s) {
      ...
      if (c) for (let u of Object.keys(l)) W(t, l, u, e.slice(1));
      for (let [d, p] of Object.entries(h)) {
        let f = d.replace(A, "");
        (!a || e.includes(f)) && H(t, l, o, p.callable, p.delegationSelector);
      }
    },
    trigger(t, e, i) {
      ...
      let c = j(new Event(e, { bubbles: a, cancelable: !0 }), i);
      return (
        h && c.preventDefault(),
        l && t.dispatchEvent(c),
  ...
  let V = {
    ...
    getDataAttributes(t) {
      ...
      for (let s of i) {
        let n = s.replace(/^bs/, "");
        e[(n = n.charAt(0).toLowerCase() + n.slice(1, n.length))] = Y(
          t.dataset[s]
        );
      }
      return e;
    },
    getDataAttribute: (t, e) => Y(t.getAttribute(`data-bs-${B(e)}`)),
  };
  class K {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(t, e) {
      let i = c(e) ? V.getDataAttribute(e, "config") : {};
      return {
        ...this.constructor.Default,
        ...("object" == typeof i ? i : {}),
        ...(c(e) ? V.getDataAttributes(e) : {}),
        ...("object" == typeof t ? t : {}),
      };
    }
  ...
  class X extends K {
    ...
    static getInstance(t) {
      return e.get(u(t), this.DATA_KEY);
    }
  ...
  let Q = (t) => {
    ...
    G = (t, e = "hide") => {
      ...
      q.on(document, i, `[data-bs-dismiss="${s}"]`, function (i) {
        if (
          (["A", "AREA"].includes(this.tagName) && i.preventDefault(), p(this))
        )
          return;
        let n = Z.getElementFromSelector(this) || this.closest(`.${s}`),
  ...
  class tf extends X {
    ...
    toggle() {
      this._element.setAttribute(
        "aria-pressed",
        this._element.classList.toggle(tu)
      );
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class tA extends K {
    constructor(t, e) {
      if ((super(), (this._element = t), !t || !tA.isSupported())) return;
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (q.on(this._element, t$, (t) => this._start(t)),
          q.on(this._element, ty, (t) => this._end(t)),
          this._element.classList.add(tx))
        : (q.on(this._element, tv, (t) => this._start(t)),
          q.on(this._element, t8, (t) => this._move(t)),
          q.on(this._element, tb, (t) => this._end(t)));
    }
    _eventIsPointerPenTouch(t) {
      return (
        this._supportPointerEvents &&
        (t.pointerType === t_ || t.pointerType === tw)
      );
    }
    static isSupported() {
      return (
  ...
  let tS = "carousel",
    ...
    tB = "active",
    t1 = "slide",
    t7 = "carousel-item-end",
    t5 = "carousel-item-start",
    tV = "carousel-item-next",
    tK = "carousel-item-prev",
    tU = ".active",
    t6 = ".carousel-item",
    t2 = tU + t6,
    tX = ".carousel-item img",
    t4 = ".carousel-indicators",
    tQ = "[data-bs-slide], [data-bs-slide-to]",
    tZ = '[data-bs-ride="carousel"]',
    tG = { [tI]: t0, [tT]: tL },
    tJ = {
      interval: 5e3,
      keyboard: !0,
  ...
  class ee extends X {
    constructor(t, e) {
      super(t, e),
        ...
        (this._indicatorsElement = Z.findOne(t4, this._element)),
        this._addEventListeners(),
        this._config.ride === tY && this.cycle();
    }
    static get Default() {
      return tJ;
    }
    ...
    _maybeEnableCycle() {
      if (this._config.ride) {
        if (this._isSliding) {
          q.one(this._element, tH, () => this.cycle());
          return;
        }
        this.cycle();
      }
    ...
    to(t) {
      ...
      if (this._isSliding) {
        q.one(this._element, tH, () => this.to(t));
        return;
      }
    ...
    _addEventListeners() {
      this._config.keyboard && q.on(this._element, tW, (t) => this._keydown(t)),
        "hover" === this._config.pause &&
          (q.on(this._element, tR, () => this.pause()),
          q.on(this._element, t9, () => this._maybeEnableCycle())),
        this._config.touch &&
          tA.isSupported() &&
          this._addTouchEventListeners();
    }
    _addTouchEventListeners() {
      for (let t of Z.find(tX, this._element))
      ...
      let e = () => {
          "hover" === this._config.pause &&
            ...
            (this.touchTimeout = setTimeout(
              ...
              tz + this._config.interval
            )));
        },
        i = {
          leftCallback: () => this._slide(this._directionToOrder(tL)),
          rightCallback: () => this._slide(this._directionToOrder(t0)),
          endCallback: e,
        };
      this._swipeHelper = new tA(this._element, i);
    }
    _keydown(t) {
    ...
    _setActiveIndicatorElement(t) {
      ...
      let e = Z.findOne(tU, this._indicatorsElement);
      e.classList.remove(tB), e.removeAttribute("aria-current");
      let i = Z.findOne(`[data-bs-slide-to="${t}"]`, this._indicatorsElement);
      i && (i.classList.add(tB), i.setAttribute("aria-current", "true"));
    }
    _updateInterval() {
    ...
    _isAnimated() {
      return this._element.classList.contains(t1);
    }
    _getActive() {
      return Z.findOne(t2, this._element);
    }
    _getItems() {
      return Z.find(t6, this._element);
    }
    _clearInterval() {
      this._interval &&
    ...
    _directionToOrder(t) {
      return y() ? (t === tL ? tO : tM) : t === tL ? tM : tO;
    }
    _orderToDirection(t) {
      return y() ? (t === tO ? tL : t0) : t === tO ? t0 : tL;
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  q.on(document, tj, tQ, function (t) {
    let e = Z.getElementFromSelector(this);
    if (!e || !e.classList.contains(tY)) return;
    t.preventDefault();
    let i = ee.getOrCreateInstance(e),
    ...
    q.on(window, tq, () => {
      let t = Z.find(tZ);
      for (let e of t) ee.getOrCreateInstance(e);
    }),
    w(ee);
  let ei = "collapse",
    es = "bs.collapse",
  ...
  class e_ extends X {
    constructor(t, e) {
      ...
      let i = Z.find(e$);
      for (let s of i) {
        let n = Z.getSelectorFromElement(s),
          r = Z.find(n).filter((t) => t === this._element);
    ...
    show() {
      ...
      if (
        (this._config.parent &&
          (t = this._getFirstLevelChildren(eb)
            .filter((t) => t !== this._element)
            .map((t) => e_.getOrCreateInstance(t, { toggle: !1 }))),
        t.length && t[0]._isTransitioning)
      )
        return;
      let e = q.trigger(this._element, eo);
      ...
      let n = () => {
          (this._isTransitioning = !1),
            ...
            this._element.classList.add(ed, eu),
            (this._element.style[s] = ""),
            q.trigger(this._element, ea);
        },
    ...
    hide() {
      if (this._isTransitioning || !this._isShown()) return;
      let t = q.trigger(this._element, el);
      if (t.defaultPrevented) return;
      ...
      m(this._element),
      this._element.classList.add(ep),
      this._element.classList.remove(ed, eu),
      this._triggerArray)) {
        let s = Z.getElementFromSelector(i);
    ...
    _getDimension() {
      return this._element.classList.contains(em) ? ev : e8;
    }
    _initializeChildren() {
      if (!this._config.parent) return;
      let t = this._getFirstLevelChildren(e$);
      for (let e of t) {
        let i = Z.getElementFromSelector(e);
        i && this._addAriaAndCollapsedClass([e], this._isShown(i));
      }
    }
    _getFirstLevelChildren(t) {
      let e = Z.find(eg, this._config.parent);
      return Z.find(t, this._config.parent).filter((t) => !e.includes(t));
    }
    _addAriaAndCollapsedClass(t, e) {
      if (t.length)
        for (let i of t)
          i.classList.toggle(ef, !e), i.setAttribute("aria-expanded", e);
    }
    static jQueryInterface(t) {
      let e = {};
      return (
        ...
        this.each(function () {
          let i = e_.getOrCreateInstance(this, e);
          if ("string" == typeof t) {
  ...
  var ex = "top",
    ...
    eT = "popper",
    ez = "reference",
    eM = eS.reduce(function (t, e) {
      return t.concat([e + "-" + eE, e + "-" + eF]);
    }, []),
    eO = [].concat(eS, [eA]).reduce(function (t, e) {
      return t.concat([e, e + "-" + eE, e + "-" + eF]);
    }, []),
    eL = "beforeRead",
    e0 = "read",
    eN = "afterRead",
  ...
  function e7(t) {
    var e = eB(t).HTMLElement;
    return t instanceof e || t instanceof HTMLElement;
  }
  function e5(t) {
    if ("undefined" == typeof ShadowRoot) return !1;
    var e = eB(t).ShadowRoot;
  ...
  function eG(t, e, i) {
    ...
    e &&
      e7(t) &&
      ((n = (t.offsetWidth > 0 && e4(s.width) / t.offsetWidth) || 1),
      (r = (t.offsetHeight > 0 && e4(s.height) / t.offsetHeight) || 1));
    var o = (e1(t) ? eB(t) : window).visualViewport,
      a = !eZ() && i,
  ...
  function ie(t) {
    return eB(t).getComputedStyle(t);
  }
  function ii(t) {
    return ["table", "td", "th"].indexOf(eY(t)) >= 0;
  }
  function is(t) {
    return (
      (e1(t) ? t.ownerDocument : t.document) || window.document
    ).documentElement;
  }
  function ir(t) {
    return "html" === eY(t)
      ? t
      : t.assignedSlot || t.parentNode || (e5(t) ? t.host : null) || is(t);
  }
  function io(t) {
    return e7(t) && "fixed" !== ie(t).position ? t.offsetParent : null;
  }
  function ia(t) {
    var e = /firefox/i.test(eQ());
    if (/Trident/i.test(eQ()) && e7(t) && "fixed" === ie(t).position)
      return null;
    var i = ir(t);
    for (
      e5(i) && (i = i.host);
      e7(i) && 0 > ["html", "body"].indexOf(eY(i));
  ...
  function il(t) {
    for (var e = eB(t), i = io(t); i && ii(i) && "static" === ie(i).position; )
      i = io(i);
    return i &&
      ("html" === eY(i) || ("body" === eY(i) && "static" === ie(i).position))
      ? e
      : i || ia(t) || e;
  }
  function ih(t) {
  ...
  function iv(t) {
    var e,
      ...
      a = e6(i.placement),
      l = ih(a),
      h = [eD, ek].indexOf(a) >= 0 ? "height" : "width";
    if (r && o) {
      var c = im(n.padding, i),
        u = eJ(r),
        d = "y" === l ? ex : eD,
        p = "y" === l ? eC : ek,
        f =
  ...
  function iw(t, e) {
    ...
    return { x: e4(i * n) / n || 0, y: e4(s * n) / n || 0 };
  }
  function i_(t) {
    var e,
      i,
    ...
    if (c) {
      ...
      x === eB(s) &&
        ...
        (r === eD || ((r === ex || r === eC) && o === eF)) &&
          ((y = ek),
          (f -=
            (d && x === _ && _.visualViewport ? _.visualViewport.width : x[k]) -
            n.width),
          (f *= h ? 1 : -1));
    }
    var D = Object.assign({ position: l }, c && iy),
      A = !0 === u ? iw({ x: f, y: m }, eB(s)) : { x: f, y: m };
    return ((f = A.x), (m = A.y), h)
      ? Object.assign(
          {},
          D,
          (((i = {})[w] = $ ? "0" : ""),
  ...
  function iD(t) {
    var e = t.state,
      ...
      o = s.resize,
      a = void 0 === o || o,
      l = eB(e.elements.popper),
      h = [].concat(e.scrollParents.reference, e.scrollParents.popper);
    return (
      r &&
        h.forEach(function (t) {
          t.addEventListener("scroll", i.update, ik);
        }),
      a && l.addEventListener("resize", i.update, ik),
      function () {
        r &&
          h.forEach(function (t) {
            t.removeEventListener("scroll", i.update, ik);
          }),
          a && l.removeEventListener("resize", i.update, ik);
      }
    );
  }
  let iA = {
  ...
  var iS = { left: "right", right: "left", bottom: "top", top: "bottom" };
  function iE(t) {
    return t.replace(/left|right|bottom|top/g, function (t) {
      return iS[t];
    });
  }
  var iF = { start: "end", end: "start" };
  function iP(t) {
  ...
  function iT(t) {
    return eG(is(t)).left + iI(t).scrollLeft;
  }
  function iz(t, e) {
    var i = eB(t),
      s = is(t),
    ...
    return { width: r, height: o, x: a + iT(t), y: l };
  }
  function iM(t) {
    var e,
      i = is(t),
      ...
      l = -s.scrollTop;
    return (
      "rtl" === ie(n || i).direction &&
        (a += e2(i.clientWidth, n ? n.clientWidth : 0) - r),
  ...
  function i0(t, e) {
    ...
    var i,
      ...
      r = eB(s),
      o = n ? [r].concat(r.visualViewport || [], iO(s) ? s : []) : s,
      a = e.concat(o);
    return n ? a : a.concat(i0(ir(o)));
  }
  function iN(t) {
  ...
  function iW(t, e, i) {
    return e === eI ? iN(iz(t, i)) : e1(e) ? iH(e, i) : iN(iM(is(t)));
  }
  function iR(t) {
    var e = i0(ir(t)),
      i =
        ["absolute", "fixed"].indexOf(ie(t).position) >= 0 && e7(t) ? il(t) : t;
    return e1(i)
      ? e.filter(function (t) {
          return e1(t) && it(t, i) && "body" !== eY(t);
        })
      : [];
  }
  function i9(t, e, i, s) {
    var n = [].concat("clippingParents" === e ? iR(t) : [].concat(e), [i]),
      ...
      o = n.reduce(function (e, i) {
        ...
        return (
          ...
          (e.right = eX(n.right, e.right)),
          (e.bottom = eX(n.bottom, e.bottom)),
  ...
  function iq(t, e) {
    ...
    var i = e,
      ...
      g = i.padding,
      m = void 0 === g ? 0 : g,
      v = ip("number" != typeof m ? m : ig(m, eS)),
      b = d === eT ? ez : eT,
      $ = t.rects.popper,
      y = t.elements[f ? b : d],
      w = i9(e1(y) ? y : y.contextElement || is(t.elements.popper), l, c, o),
      _ = eG(t.elements.reference),
      x = i3({ reference: _, element: $, strategy: "absolute", placement: n }),
      C = iN(Object.assign({}, $, x)),
      k = d === eT ? C : _,
      D = {
    ...
    if (d === eT && A) {
      ...
      Object.keys(D).forEach(function (t) {
        var e = [ek, eC].indexOf(t) >= 0 ? 1 : -1,
          i = [ex, eC].indexOf(t) >= 0 ? "y" : "x";
        D[t] += S[i] * e;
      });
    }
    return D;
  ...
  function iB(t) {
    ...
    if (!e.modifiersData[s]._skip) {
      ...
      e.placement !== k &&
        ((e.modifiersData[s]._skip = !0), (e.placement = k), (e.reset = !0));
    }
  }
  let i1 = {
    name: "flip",
  ...
  function i5(t) {
    return [ex, ek, eC, eD].some(function (e) {
      return t[e] >= 0;
    });
  }
  function iV(t) {
    var e = t.state,
      ...
      o = iq(e, { elementContext: "reference" }),
      a = iq(e, { altBoundary: !0 }),
      l = i7(o, s),
      h = i7(a, n, r),
      c = i5(l),
      u = i5(h);
  ...
  function iU(t, e, i) {
    ...
    return (
      (o = o || 0),
      (a = (a || 0) * n),
      [eD, ek].indexOf(s) >= 0 ? { x: a, y: o } : { x: o, y: a }
    );
  }
  function i6(t) {
    var e = t.state,
      ...
      n = i.offset,
      r = void 0 === n ? [0, 0] : n,
      o = eO.reduce(function (t, i) {
        return (t[i] = iU(i, e.rects, r)), t;
      }, {}),
      a = o[e.placement],
      l = a.x,
      h = a.y;
  ...
  function iZ(t) {
    var e = t.state,
      ...
      f = i.tetherOffset,
      g = void 0 === f ? 0 : f,
      m = iq(e, { boundary: l, rootBoundary: h, padding: u, altBoundary: c }),
      v = e6(e.placement),
      b = i$(e.placement),
      $ = !b,
      y = ih(v),
    ...
    if (_) {
      if (r) {
        var E,
          ...
          j = R[P],
          Y = ic(0, x[I], W[I]),
          B = $ ? x[I] / 2 - O - Y - q - D.mainAxis : L - Y - q - D.mainAxis,
          V = $ ? -x[I] / 2 + O + Y + j + D.mainAxis : N + Y + j + D.mainAxis,
          K = e.elements.arrow && il(e.elements.arrow),
          U = K ? ("y" === y ? K.clientTop || 0 : K.clientLeft || 0) : 0,
          X = null != (E = null == A ? void 0 : A[y]) ? E : 0,
          Q = T + B - X - U,
          Z = T + V - X,
          G = ic(p ? eX(z, Q) : z, T, p ? e2(M, Z) : M);
        (_[y] = G), (S[y] = G - T);
      }
      if (a) {
        var J,
  ...
  function st(t) {
    return t !== eB(t) && e7(t) ? iJ(t) : iI(t);
  }
  function se(t) {
    var e = t.getBoundingClientRect(),
      i = e4(e.width) / t.offsetWidth || 1,
      s = e4(e.height) / t.offsetHeight || 1;
    return 1 !== i || 1 !== s;
  }
  function si(t, e, i) {
    void 0 === i && (i = !1);
    ...
    return (
      (s || (!s && !i)) &&
        (("body" !== eY(e) || iO(r)) && (a = st(e)),
        e7(e)
          ? ((l = eG(e, !0)), (l.x += e.clientLeft), (l.y += e.clientTop))
          : r && (l.x = iT(r))),
      {
      ...
      var o = {
        ...
        h = {
          ...
          setOptions: function t(n) {
            ...
            var l = sn(so([].concat(s, o.options.modifiers)));
            return (
              (o.orderedModifiers = l.filter(function (t) {
                return t.enabled;
              })),
              c(),
              h.update()
          ...
          forceUpdate: function t() {
            if (!l) {
              ...
              if (sl(i, s)) {
                (o.rects = {
                  reference: si(i, il(s), "fixed" === o.options.strategy),
                  popper: eJ(s),
                }),
                  (o.reset = !1),
                ...
                for (var n = 0; n < o.orderedModifiers.length; n++) {
                  ...
                  "function" == typeof a &&
                    (o =
                      a({ state: o, options: u, name: d, instance: h }) || o);
                }
              }
            }
          },
  ...
  var sc = sh(),
    su = [iA, i4, iC, eU],
    sd = sh({ defaultModifiers: su }),
    sp = [iA, i4, iC, eU, i2, i1, iG, ib, iK],
    sf = sh({ defaultModifiers: sp });
  let sg = Object.freeze(
    ...
    sq = y() ? "bottom-end" : "bottom-start",
    sj = y() ? "bottom-start" : "bottom-end",
    sY = y() ? "left-start" : "right-start",
    sB = y() ? "right-start" : "left-start",
    s1 = "top",
    s7 = "bottom",
    s5 = {
      autoClose: !0,
  ...
  class sK extends X {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          Z.next(this._element, sN)[0] ||
          Z.prev(this._element, sN)[0] ||
          Z.findOne(sN, this._parent)),
    ...
    show() {
      ...
      let t = { relatedTarget: this._element },
        e = q.trigger(this._element, sD, t);
      if (!e.defaultPrevented) {
        if (
          (this._createPopper(),
          "ontouchstart" in document.documentElement &&
            !this._parent.closest(sW))
        )
          for (let i of [].concat(...document.body.children))
            q.on(i, "mouseover", g);
        this._element.focus(),
          this._element.setAttribute("aria-expanded", !0),
          this._menu.classList.add(sP),
          this._element.classList.add(sP),
          q.trigger(this._element, sA, t);
      }
    }
    hide() {
      if (p(this._element) || !this._isShown()) return;
    ...
    _getConfig(t) {
      if (
        ...
        throw TypeError(
          `${sm.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`
        );
      return t;
    }
    _createPopper() {
      ...
      "parent" === this._config.reference
        ...
        ? (t = u(this._config.reference))
        : "object" == typeof this._config.reference &&
          (t = this._config.reference);
      let e = this._getPopperConfig();
      this._popper = sf(t, this._menu, e);
    }
    _isShown() {
      return this._menu.classList.contains(sP);
    }
    _getPlacement() {
      let t = this._parent;
      if (t.classList.contains(sT)) return sY;
      ...
      return t.classList.contains(sI) ? (e ? s3 : s9) : e ? sj : sq;
    }
    _detectNavbar() {
      return null !== this._element.closest(sH);
    }
    _getOffset() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      let i = Z.find(sR, this._menu).filter((t) => d(t));
      i.length && C(i, e, t === s_, !i.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
        let e = sK.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
    ...
    static clearMenus(t) {
      if (t.button === sx || ("keyup" === t.type && t.key !== sy)) return;
      let e = Z.find(s0);
      for (let i of e) {
        let s = sK.getInstance(i);
    ...
    static dataApiKeydownHandler(t) {
      let e = /input|textarea/i.test(t.target.tagName),
        i = t.key === s$,
        s = [sw, s_].includes(t.key);
      if ((!s && !i) || (e && !i)) return;
      t.preventDefault();
      let n = this.matches(sL)
          ? this
          : Z.prev(this, sL)[0] ||
            Z.next(this, sL)[0] ||
            Z.findOne(sL, t.delegateTarget.parentNode),
        r = sK.getOrCreateInstance(n);
      if (s) {
  ...
  q.on(document, sE, sL, sK.dataApiKeydownHandler),
    q.on(document, sE, sN, sK.dataApiKeydownHandler),
    q.on(document, sS, sK.clearMenus),
    q.on(document, sF, sK.clearMenus),
    q.on(document, sS, sL, function (t) {
      t.preventDefault(), sK.getOrCreateInstance(this).toggle();
    }),
    w(sK);
  let sU = "backdrop",
    s6 = "fade",
  ...
  class sZ extends K {
    ...
    hide(t) {
      ...
      this._getElement().classList.remove(s2),
        this._emulateAnimation(() => {
          this.dispose(), _(t);
        });
    }
    ...
    _getElement() {
      if (!this._element) {
        ...
        (t.className = this._config.className),
          this._config.isAnimated && t.classList.add(s6),
          (this._element = t);
      }
  ...
  let sG = "focustrap",
    ...
    nn = "forward",
    nr = "backward",
    no = { autofocus: !0, trapElement: null },
    na = { autofocus: "boolean", trapElement: "element" };
  class nl extends K {
    constructor(t) {
      super(),
        (this._config = this._getConfig(t)),
    ...
    activate() {
      !this._isActive &&
        ...
        q.off(document, nt),
        q.on(document, ne, (t) => this._handleFocusin(t)),
        q.on(document, ni, (t) => this._handleKeydown(t)),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), q.off(document, nt));
    }
    _handleFocusin(t) {
      let { trapElement: e } = this._config;
      if (t.target === document || t.target === e || e.contains(t.target))
        return;
      let i = Z.focusableChildren(e);
      0 === i.length
        ? e.focus()
    ...
    _handleKeydown(t) {
      t.key === ns && (this._lastTabNavDirection = t.shiftKey ? nr : nn);
    }
  }
  let nh = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    nc = ".sticky-top",
    nu = "padding-right",
    nd = "margin-right";
  class np {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        this._setElementAttributes(this._element, nu, (e) => e + t),
        this._setElementAttributes(nh, nu, (e) => e + t),
        this._setElementAttributes(nc, nd, (e) => e - t);
    }
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        this._resetElementAttributes(this._element, nu),
        this._resetElementAttributes(nh, nu),
        this._resetElementAttributes(nc, nd);
    }
    isOverflowing() {
    ...
    _applyManipulationCallback(t, e) {
      ...
      for (let i of Z.find(t, this._element)) e(i);
    }
  }
  let nf = "modal",
    ng = "bs.modal",
    ...
    nx = `resize${nm}`,
    nC = `click.dismiss${nm}`,
    nk = `mousedown.dismiss${nm}`,
    nD = `keydown.dismiss${nm}`,
    nA = `click${nm}${nv}`,
    nS = "modal-open",
    nE = "fade",
    nF = "show",
    ...
    nT = ".modal-dialog",
    nz = ".modal-body",
    nM = '[data-bs-toggle="modal"]',
    nO = { backdrop: !0, focus: !0, keyboard: !0 },
    nL = {
  ...
  class n0 extends X {
    constructor(t, e) {
      super(t, e),
        (this._dialog = Z.findOne(nT, this._element)),
        (this._backdrop = this._initializeBackDrop()),
        (this._focustrap = this._initializeFocusTrap()),
        (this._isShown = !1),
        (this._isTransitioning = !1),
        (this._scrollBar = new np()),
        this._addEventListeners();
    }
    static get Default() {
      return nO;
    ...
    show(t) {
      ...
      let e = q.trigger(this._element, nw, { relatedTarget: t });
      !e.defaultPrevented &&
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    hide() {
      if (!this._isShown || this._isTransitioning) return;
      let t = q.trigger(this._element, nb);
      !t.defaultPrevented &&
        ((this._isShown = !1),
        (this._isTransitioning = !0),
    ...
    _initializeFocusTrap() {
      return new nl({ trapElement: this._element });
    }
    _showElement(t) {
      ...
      let e = Z.findOne(nz, this._dialog);
      e && (e.scrollTop = 0), m(this._element), this._element.classList.add(nF);
      let i = () => {
        this._config.focus && this._focustrap.activate(),
          (this._isTransitioning = !1),
          q.trigger(this._element, n_, { relatedTarget: t });
      };
    ...
    _addEventListeners() {
      q.on(this._element, nD, (t) => {
        ...
        q.on(this._element, nk, (t) => {
          q.one(this._element, nC, (e) => {
    ...
    _triggerBackdropTransition() {
      ...
      !("hidden" === i || this._element.classList.contains(nP)) &&
        (e || (this._element.style.overflowY = "hidden"),
        this._element.classList.add(nP),
        this._queueCallback(() => {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        let i = n0.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === i[t]) throw TypeError(`No method named "${t}"`);
          i[t](e);
        }
  ...
  q.on(document, nA, nM, function (t) {
    let e = Z.getElementFromSelector(this);
    ...
    let i = Z.findOne(nI);
    i && n0.getInstance(i).hide();
    let s = n0.getOrCreateInstance(e);
    s.toggle(this);
  }),
    G(n0),
    w(n0);
  let nN = "offcanvas",
    ...
    n6 = `resize${nW}`,
    n2 = `click${nW}${nR}`,
    nX = `keydown.dismiss${nW}`,
    n4 = '[data-bs-toggle="offcanvas"]',
    nQ = { backdrop: !0, keyboard: !0, scroll: !1 },
    nZ = {
      backdrop: "(boolean|string)",
      keyboard: "boolean",
      scroll: "boolean",
  ...
  class nG extends X {
    ...
    show(t) {
      ...
      let e = q.trigger(this._element, n7, { relatedTarget: t });
      if (e.defaultPrevented) return;
      (this._isShown = !0),
        this._backdrop.show(),
        this._config.scroll || new np().hide(),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
      ...
      let i = () => {
        (!this._config.scroll || this._config.backdrop) &&
          ...
          this._element.classList.remove(nj),
          q.trigger(this._element, n5, { relatedTarget: t });
      };
      this._queueCallback(i, this._element, !0);
    }
    hide() {
      if (!this._isShown) return;
      let t = q.trigger(this._element, nV);
      if (t.defaultPrevented) return;
      this._focustrap.deactivate(),
        this._element.blur(),
        (this._isShown = !1),
        ...
        this._backdrop.hide();
      let e = () => {
        this._element.classList.remove(nq, nY),
          this._element.removeAttribute("aria-modal"),
          this._element.removeAttribute("role"),
          this._config.scroll || new np().reset(),
  ...
  q.on(document, n2, n4, function (t) {
    let e = Z.getElementFromSelector(this);
    ...
    let s = nG.getOrCreateInstance(e);
    s.toggle(this);
  }),
    q.on(window, n9, () => {
      for (let t of Z.find(n1)) nG.getOrCreateInstance(t).show();
    }),
    q.on(window, n6, () => {
      for (let t of Z.find("[aria-modal][class*=show][class*=offcanvas-]"))
  ...
  let nJ = /^aria-[\w-]*$/i,
    ...
    rs = (t, e) => {
      ...
      return e.includes(i)
        ? !re.has(i) || Boolean(ri.test(t.nodeValue))
  ...
  function rn(t, e, i) {
    ...
    for (let o of r) {
      ...
      let l = [].concat(...o.attributes),
        h = [].concat(e["*"] || [], e[a] || []);
      for (let c of l) rs(c, h) || o.removeAttribute(c.nodeName);
    }
    return n.body.innerHTML;
  }
  let rr = "TemplateFactory",
    ro = {
      allowList: rt,
      content: {},
      extraClass: "",
  ...
  class rh extends K {
    ...
    _checkContent(t) {
      for (let [e, i] of Object.entries(t))
        super._typeCheckConfig({ selector: e, entry: i }, rl);
    }
    _setContent(t, e, i) {
      let s = Z.findOne(i, t);
      if (s) {
    ...
    _maybeSanitize(t) {
      return this._config.sanitize
        ? rn(t, this._config.allowList, this._config.sanitizeFn)
        : t;
    }
  ...
  let rc = "tooltip",
    ru = new Set(["sanitize", "allowList", "sanitizeFn"]),
    rd = "fade",
    rp = "modal",
    rf = "show",
    rg = ".tooltip-inner",
  ...
  class rz extends X {
    ...
    dispose() {
      clearTimeout(this._timeout),
        q.off(this._element.closest(rm), rv, this._hideModalHandler),
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (n.append(s),
          q.trigger(this._element, this.constructor.eventName(rk))),
    ...
    hide() {
      if (!this._isShown()) return;
      let t = q.trigger(this._element, this.constructor.eventName(rw));
      if (t.defaultPrevented) return;
      let e = this._getTipElement();
      if ((e.classList.remove(rf), "ontouchstart" in document.documentElement))
        for (let i of [].concat(...document.body.children))
          q.off(i, "mouseover", g);
      (this._activeTrigger[r$] = !1),
        (this._activeTrigger[rb] = !1),
        (this._activeTrigger[r8] = !1),
        (this._isHovered = null);
      let s = () => {
        !this._isWithActiveTrigger() &&
          (this._isHovered || this._disposePopper(),
          this._element.removeAttribute("aria-describedby"),
          q.trigger(this._element, this.constructor.eventName(r_)));
      };
    ...
    _createTipElement(t) {
      ...
      if (!e) return null;
      e.classList.remove(rd, rf),
        e.classList.add(`bs-${this.constructor.NAME}-auto`);
      let i = a(this.constructor.NAME).toString();
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(rd), e
      );
    }
    setContent(t) {
      (this._newContent = t),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(rd))
      );
    }
    _isShown() {
      return this.tip && this.tip.classList.contains(rf);
    }
    _createPopper(t) {
      let e = _(this._config.placement, [this, t, this._element]),
        i = rP[e.toUpperCase()];
      return sf(this._element, t, this._getPopperConfig(i));
    }
    _getOffset() {
      let { offset: t } = this._config;
      return "string" == typeof t
    ...
    _getPopperConfig(t) {
      ...
      return { ...e, ..._(this._config.popperConfig, [e]) };
    }
    _setListeners() {
      ...
      for (let e of t)
        if ("click" === e)
          ...
          let i =
              e === r8
                ? this.constructor.eventName(rE)
                : this.constructor.eventName(rA),
            s =
              e === r8
                ? this.constructor.eventName(rF)
                : this.constructor.eventName(rS);
          q.on(this._element, i, this._config.selector, (t) => {
            let e = this._initializeOnDelegatedTarget(t);
            (e._activeTrigger["focusin" === t.type ? rb : r8] = !0), e._enter();
          }),
            q.on(this._element, s, this._config.selector, (t) => {
              let e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger["focusout" === t.type ? rb : r8] =
      ...
      (this._hideModalHandler = () => {
        ...
        q.on(this._element.closest(rm), rv, this._hideModalHandler);
    }
    _fixTitle() {
    ...
    _getConfig(t) {
      ...
      for (let i of Object.keys(e)) ru.has(i) && delete e[i];
      return (
    ...
    _configAfterMerge(t) {
      return (
        (t.container = !1 === t.container ? document.body : u(t.container)),
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        let e = rz.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  let rM = "popover",
    ...
    rN = { ...rz.DefaultType, content: "(null|string|element|function)" };
  class rH extends rz {
    static get Default() {
      return r0;
    }
    ...
    _getContentForTemplate() {
      return { [rO]: this._getTitle(), [rL]: this._getContent() };
    }
    _getContent() {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        let e = rH.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  class rG extends X {
    ...
    _configAfterMerge(t) {
      return (
        (t.target = u(t.target) || document.body),
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (q.off(this._config.target, rj),
        q.on(this._config.target, rj, r5, (t) => {
    ...
    _initializeTargetsAndObservables() {
      ...
      let t = Z.find(r5, this._config.target);
      for (let e of t) {
        if (!e.hash || p(e)) continue;
        let i = Z.findOne(decodeURI(e.hash), this._element);
        d(i) &&
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        q.trigger(this._element, rq, { relatedTarget: t }));
    }
    _activateParents(t) {
      if (t.classList.contains(rB)) {
        Z.findOne(r4, t.closest(rX)).classList.add(r1);
        return;
      }
      for (let e of Z.parents(t, rV))
        for (let i of Z.prev(e, r2)) i.classList.add(r1);
    }
    _clearActiveClass(t) {
      t.classList.remove(r1);
      let e = Z.find(`${r5}.${r1}`, t);
      for (let i of e) i.classList.remove(r1);
    }
    static jQueryInterface(t) {
      return this.each(function () {
        let e = rG.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === e[t] || t.startsWith("_") || "constructor" === t)
            throw TypeError(`No method named "${t}"`);
          e[t]();
  ...
  q.on(window, rY, () => {
    for (let t of Z.find(r7)) rG.getOrCreateInstance(t);
  }),
    w(rG);
  let rJ = "tab",
    ot = "bs.tab",
  ...
  class oA extends X {
    constructor(t) {
      if ((super(t), (this._parent = this._element.closest(ow)), !this._parent))
        return;
      this._setInitialAttributes(this._parent, this._getChildren()),
        q.on(this._element, oa, (t) => this._keydown(t));
    }
    static get NAME() {
      return rJ;
    }
    show() {
      ...
      let e = this._getActiveElem(),
        i = e ? q.trigger(e, oi, { relatedTarget: t }) : null,
        s = q.trigger(t, on, { relatedTarget: e });
      !s.defaultPrevented &&
    ...
    _activate(t, e) {
      if (!t) return;
      t.classList.add(og), this._activate(Z.getElementFromSelector(t));
      let i = () => {
        ...
        t.removeAttribute("tabindex"),
          ...
          q.trigger(t, or, { relatedTarget: e });
      };
    ...
    _deactivate(t, e) {
      ...
      let i = () => {
        ...
        t.setAttribute("aria-selected", !1),
          ...
          q.trigger(t, os, { relatedTarget: e });
      };
      this._queueCallback(i, t, t.classList.contains(om));
    }
    _keydown(t) {
      if (![oh, oc, ou, od, op, of].includes(t.key)) return;
      t.stopPropagation(), t.preventDefault();
      let e = this._getChildren().filter((t) => !p(t)),
        i;
      if ([op, of].includes(t.key)) i = e[t.key === op ? 0 : e.length - 1];
      else {
        let s = [oc, od].includes(t.key);
        i = C(e, t.target, s, !0);
      }
      i && (i.focus({ preventScroll: !0 }), oA.getOrCreateInstance(i).show());
    }
    _getChildren() {
      return Z.find(ok, this._parent);
    }
    _getActiveElem() {
    ...
    _getInnerElement(t) {
      return t.matches(ok) ? t : Z.findOne(ok, t);
    }
    _getOuterElement(t) {
  ...
  q.on(document, oo, oC, function (t) {
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
      !p(this) && oA.getOrCreateInstance(this).show();
  }),
    q.on(window, ol, () => {
      for (let t of Z.find(oD)) oA.getOrCreateInstance(t);
    }),
    w(oA);
  let oS = "toast",
    oE = "bs.toast",
    ...
    oW = "show",
    oR = "showing",
    o9 = { animation: "boolean", autohide: "boolean", delay: "number" },
    o3 = { animation: !0, autohide: !0, delay: 5e3 };
  class oq extends X {
    constructor(t, e) {
      super(t, e),
        (this._timeout = null),
    ...
    _setListeners() {
      q.on(this._element, oP, (t) => this._onInteraction(t, !0)),
        q.on(this._element, oI, (t) => this._onInteraction(t, !1)),
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        let e = oq.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw TypeError(`No method named "${t}"`);
          e[t](this);
        }
   ...
   * Copyright (c) 2012 AUTHORS.txt; Licensed MIT, GPL */ (function (t, e) {
    function i(e, i) {
          ...
          zIndex: function (i) {
            ...
            if (this.length)
              for (var s, n, r = t(this[0]); r.length && r[0] !== document; ) {
                if (
                  ("absolute" === (s = r.css("position")) ||
                    "relative" === s ||
                    "fixed" === s) &&
                  ((n = parseInt(r.css("zIndex"), 10)), !isNaN(n) && 0 !== n)
                )
                  return n;
                r = r.parent();
              }
              ...
              return (
                t.each(r, function () {
                  (i -= parseFloat(t.curCSS(e, "padding" + this, !0)) || 0),
                    ...
                    n &&
                      (i -= parseFloat(t.curCSS(e, "margin" + this, !0)) || 0);
                }),
                i
              );
            }
      ...
      (t.widget.bridge = function (i, s) {
        t.fn[i] = function (n) {
          var r = "string" == typeof n,
            ...
            a = this;
          return (
            (n = !r && o.length ? t.extend.apply(null, [!0, n].concat(o)) : n),
            (r && "_" === n.charAt(0)) ||
              (r
                ? this.each(function () {
                    var s = t.data(this, i),
      ...
      (t.Widget.prototype = {
        ...
        _trigger: function (e, i, s) {
          ...
          return (
            ...
            !(
              (t.isFunction(o) && !1 === o.call(this.element[0], i, s)) ||
          ...
          ("document" == e.containment || "window" == e.containment) &&
            (this.containment = [
              ...
              ("document" == e.containment ? 0 : t(window).scrollLeft()) +
                t("document" == e.containment ? document : window).width() -
                this.helperProportions.width -
                this.margins.left,
              ("document" == e.containment ? 0 : t(window).scrollTop()) +
                (t("document" == e.containment ? document : window).height() ||
      ...
      _generatePosition: function (e) {
        ...
        if (this.originalPosition) {
          ...
          if (s.grid) {
            ...
            a =
              i &&
              (h - this.offset.click.top < i[1] ||
                h - this.offset.click.top > i[3])
                ? h - this.offset.click.top < i[1]
                  ? h + s.grid[1]
                  : h - s.grid[1]
                : h;
            ...
            o =
              i &&
              (c - this.offset.click.left < i[0] ||
                c - this.offset.click.left > i[2])
                ? c - this.offset.click.left < i[0]
                  ? c + s.grid[0]
                  : c - s.grid[0]
                : c;
          ...
          s.scrollParent[0] != document && "HTML" != s.scrollParent[0].tagName
            ? ((!n.axis || "x" != n.axis) &&
                (s.overflowOffset.top +
                  s.scrollParent[0].offsetHeight -
                  e.pageY <
                n.scrollSensitivity
                  ? (s.scrollParent[0].scrollTop = r =
              ...
              (!n.axis || "y" != n.axis) &&
                (s.overflowOffset.left +
                  s.scrollParent[0].offsetWidth -
                  e.pageX <
                n.scrollSensitivity
                  ? (s.scrollParent[0].scrollLeft = r =
      ...
      t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function (e, i) {
          for (
            ...
            if (
              !(
                (u - r < o && o < d + r && p - r < l && l < f + r) ||
                (u - r < o && o < d + r && p - r < h && h < f + r) ||
                (u - r < a && a < d + r && p - r < l && l < f + r) ||
                (u - r < a && a < d + r && p - r < h && h < f + r)
              )
            ) {
              s.snapElements[c].snapping &&
                ...
                s.options.snap.release.call(
                  s.element,
                  e,
                  t.extend(s._uiHash(), { snapItem: s.snapElements[c].item })
                ),
            ...
            if ("inner" != n.snapMode) {
              ...
              g &&
                ...
                m &&
                  (i.position.top =
                    s._convertPositionTo("relative", { top: f, left: 0 }).top -
                    s.margins.top),
                v &&
                  (i.position.left =
                    s._convertPositionTo("relative", {
                ...
                b &&
                  (i.position.left =
                    s._convertPositionTo("relative", { top: 0, left: d }).left -
                    s.margins.left);
            }
            var $ = g || m || v || b;
            if ("outer" != n.snapMode) {
  ...
  (function (t, e) {
    t.widget("ui.droppable", {
      ...
      destroy: function () {
        for (
          var e = t.ui.ddmanager.droppables[this.options.scope], i = 0;
          i < e.length;
          i++
        )
      ...
      (t.ui.intersect = function (e, i, s) {
        ...
        switch (s) {
          ...
          case "touch":
            return (
              ((o >= c && o <= u) || (a >= c && a <= u) || (o < c && a > u)) &&
              ((n >= l && n <= h) || (r >= l && r <= h) || (n < l && r > h))
            );
          default:
            return !1;
        }
      ...
      (t.ui.ddmanager = {
        ...
        prepareOffsets: function (e, i) {
          ...
          g: for (var o = 0; o < s.length; o++)
            if (
              !s[o].options.disabled &&
              (!e ||
                s[o].accept.call(s[o].element[0], e.currentItem || e.element))
            ) {
            ...
            t.each(
              ...
              function () {
                if (
                  ...
                  var s,
                    n = t.ui.intersect(e, this, this.options.tolerance),
                    r =
                      n || 1 != this.isover
                        ? n && 0 == this.isover
                          ? "isover"
                  ...
                  if (r) {
                    if (this.options.greedy) {
                      ...
                      o.length &&
                        ((s = t.data(o[0], "droppable")).greedyChild =
                          "isover" == r ? 1 : 0);
                    }
                    s &&
                      "isover" == r &&
                      ((s.isover = 0), (s.isout = 1), s._out.call(s, i)),
                      (this[r] = 1),
                      (this["isout" == r ? "isover" : "isout"] = 0),
                      this["isover" == r ? "_over" : "_out"].call(this, i),
                      s &&
                        "isout" == r &&
                        ((s.isout = 0), (s.isover = 1), s._over.call(s, i));
                  }
                }
              }
            );
  ...
  (function (t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _create: function () {
        ...
        if (
          ...
          for (var n = 0; n < s.length; n++) {
            var r = t.trim(s[n]),
              o = t(
                '<div class="ui-resizable-handle ui-resizable-' + r + '"></div>'
              );
            o.css({ zIndex: i.zIndex }),
      ...
      _mouseStart: function (e) {
        ...
        (this.resizing = !0),
          ...
          (r.is(".ui-draggable") || /absolute/.test(r.css("position"))) &&
            r.css({ position: "absolute", top: n.top, left: n.left }),
          this._renderProxy();
        var o = i(this.helper.css("left")),
          a = i(this.helper.css("top"));
        s.containment &&
          ((o += t(s.containment).scrollLeft() || 0),
        ...
        return (
          t("body").css("cursor", "auto" == l ? this.axis + "-resize" : l),
      ...
      _mouseDrag: function (e) {
        ...
        return (
          t.browser.msie && t.browser.version,
          this.sizeDiff,
      ...
      _mouseStop: function (e) {
        ...
        if (this._helper) {
          var n = this._proportionallyResizeElements,
            ...
            l = { width: s.helper.width() - a, height: s.helper.height() - o },
            h =
          ...
          i.animate || this.element.css(t.extend(l, { top: c, left: h })),
      ...
      _updateRatio: function (t, e) {
        ...
        return (
          ...
          "sw" == r &&
            ((t.left = i.left + (n.width - t.width)), (t.top = null)),
          "nw" == r &&
            ((t.top = i.top + (n.height - t.height)),
      ...
      _proportionallyResize: function () {
        if ((this.options, this._proportionallyResizeElements.length))
          for (
            var e = this.helper || this.element, i = 0;
      ...
      t.ui.plugin.add("resizable", "animate", {
        stop: function (e, i) {
          var s = t(this).data("resizable"),
            ...
            h = { width: s.size.width - l, height: s.size.height - a },
            c =
              parseInt(s.element.css("left"), 10) +
                (s.position.left - s.originalPosition.left) || null,
            u =
      ...
      t.ui.plugin.add("resizable", "containment", {
        start: function (e, s) {
          ...
          if (l) {
            if (
              ((n.containerElement = t(l)), /document/.test(a) || a == document)
            )
        ...
        resize: function (e, i) {
          ...
          h[0] != document && /static/.test(h.css("position")) && (l = r),
            o.left < (s._helper ? r.left : 0) &&
              ((s.size.width =
                s.size.width +
                (s._helper
                  ? s.position.left - r.left
                  : s.position.left - l.left)),
              a && (s.size.height = s.size.width / s.aspectRatio),
              (s.position.left = n.helper ? r.left : 0)),
            o.top < (s._helper ? r.top : 0) &&
              ((s.size.height =
                s.size.height +
                (s._helper ? s.position.top - r.top : s.position.top)),
          ...
          var c = Math.abs(
              (s._helper, s.offset.left - l.left + s.sizeDiff.width)
            ),
            u = Math.abs(
              (s._helper ? s.offset.top - l.top : s.offset.top - r.top) +
                s.sizeDiff.height
            ),
          ...
          d && p && (c -= s.parentData.left),
            c + s.size.width >= s.parentData.width &&
              ((s.size.width = s.parentData.width - c),
              a && (s.size.height = s.size.width / s.aspectRatio)),
            u + s.size.height >= s.parentData.height &&
              ((s.size.height = s.parentData.height - u),
              a && (s.size.width = s.size.height * s.aspectRatio));
        },
        stop: function (e, i) {
          var s = t(this).data("resizable"),
      ...
      t.ui.plugin.add("resizable", "grid", {
        resize: function (e, i) {
          ...
          var h =
              Math.round((r.width - o.width) / (n.grid[0] || 1)) *
              (n.grid[0] || 1),
            c =
              Math.round((r.height - o.height) / (n.grid[1] || 1)) *
              (n.grid[1] || 1);
          /^(se|s|e)$/.test(l)
            ? ((s.size.width = o.width + h), (s.size.height = o.height + c))
            : /^(ne)$/.test(l)
            ? ((s.size.width = o.width + h),
    ...
    t.widget("ui.selectable", t.ui.mouse, {
      ...
      _mouseDrag: function (e) {
        ...
        if (((this.dragged = !0), !this.options.disabled)) {
          ...
          return (
            this.helper.css({ left: n, top: r, width: o - n, height: a - r }),
            this.selectees.each(function () {
              ...
              if (l && l.element != i.element[0]) {
                ...
                "touch" == s.tolerance
                  ...
                  : "fit" == s.tolerance &&
                    (h =
                      l.left > n && l.right < o && l.top > r && l.bottom < a),
                  h
                    ? (l.selected &&
                      ...
                      l.selecting ||
                        ...
                        (l.selecting = !0),
                        i._trigger("selecting", e, { selecting: l.element })))
                    : (l.selecting &&
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _mouseDrag: function (e) {
        ...
        for (var n = this.items.length - 1; n >= 0; n--) {
          ...
          if (
            ...
            !t.ui.contains(this.placeholder[0], o) &&
            ("semi-dynamic" != this.options.type ||
              !t.ui.contains(this.element[0], o))
          ) {
            if (
          ...
          for (var i = this.containers.length - 1; i >= 0; i--)
            this.containers[i]._trigger("deactivate", null, e._uiHash(this)),
              this.containers[i].containerCache.over &&
                (this.containers[i]._trigger("out", null, e._uiHash(this)),
      ...
      refreshPositions: function (e) {
        ...
        for (var i = this.items.length - 1; i >= 0; i--) {
          ...
          if (
            ...
            var n = this.options.toleranceElement
      ...
      _contactContainers: function (e) {
        for (
          ...
          if (
            !t.ui.contains(this.currentItem[0], this.containers[n].element[0])
          ) {
            if (this._intersectsWith(this.containers[n].containerCache)) {
              if (
                i &&
                t.ui.contains(this.containers[n].element[0], i.element[0])
              )
                continue;
          ...
          if (1 === this.containers.length)
            ...
            for (
              ...
              if (
                ...
                var h = this.containers[s].floating
                  ? this.items[l].item.offset().left
                  : this.items[l].item.offset().top;
                Math.abs(h - a) < r &&
                  ((r = Math.abs(h - a)),
                  (o = this.items[l]),
            ...
            (this.currentContainer = this.containers[s]),
              o
                ...
                : this._rearrange(e, null, this.containers[s].element, !0),
              this._trigger("change", e, this._uiHash()),
        ...
        if (
          ...
          this.containment = [
            s.left +
              ...
              (parseInt(t(i).css("paddingLeft"), 10) || 0) -
              this.margins.left,
            s.top +
              (parseInt(t(i).css("borderTopWidth"), 10) || 0) +
              (parseInt(t(i).css("paddingTop"), 10) || 0) -
              this.margins.top,
            s.left +
    ...
    (function (t, e) {
      function i(e) {
        ...
        return e && e.constructor == Array && 3 == e.length
          ...
          ? h.transparent
          : h[t.trim(e).toLowerCase()];
      }
      function s(e, s) {
        var n;
        do {
          if (
            ("" != (n = (t.curCSS || t.css)(e, s)) && "transparent" != n) ||
            t.nodeName(e, "body")
          )
            break;
          s = "backgroundColor";
      ...
      (t.effects.animateClass = function (e, i, s, a) {
        ...
        t.fn.extend({
          ...
          addClass: function (e, i, s, n) {
            return i
              ? t.effects.animateClass.apply(this, [{ add: e }, i, s, n])
              : this._addClass(e);
          },
          _removeClass: t.fn.removeClass,
          removeClass: function (e, i, s, n) {
            return i
              ? t.effects.animateClass.apply(this, [{ remove: e }, i, s, n])
              : this._removeClass(e);
          },
          _toggleClass: t.fn.toggleClass,
          toggleClass: function (i, s, n, r, o) {
            return "boolean" == typeof s || s === e
              ? n
              ...
              : t.effects.animateClass.apply(this, [{ toggle: i }, s, n, r]);
          },
        ...
        t.fn.extend({
          effect: function (e, i, s, n) {
            var r = a.apply(this, arguments),
              o = { options: r[1], duration: r[2], callback: r[3] },
              l = o.options.mode,
              h = t.effects[e];
            return t.fx.off || !h
              ? l
                ? this[l](o.duration, o.callback)
                : this.each(function () {
        ...
        t.extend(t.easing, {
          ...
          easeInBack: function (t, i, s, n, r, o) {
            return (
              o == e && (o = 1.70158), n * (i /= r) * i * ((o + 1) * i - o) + s
            );
          },
          ...
          easeInOutBack: function (t, i, s, n, r, o) {
            return (
              o == e && (o = 1.70158),
              (i /= r / 2) < 1
                ? (n / 2) * i * i * (((o *= 1.525) + 1) * i - o) + s
                : (n / 2) * ((i -= 2) * i * (((o *= 1.525) + 1) * i + o) + 2) +
                  s
            );
          },
          ...
          easeInOutBounce: function (e, i, s, n, r) {
            return i < r / 2
              ? 0.5 * t.easing.easeInBounce(e, 2 * i, 0, n, r) + s
              : 0.5 * t.easing.easeOutBounce(e, 2 * i - r, 0, n, r) +
                  0.5 * n +
                  s;
          },
        });
  ...
  (function (t, e) {
    t.effects.blind = function (e) {
      return this.queue(function () {
        ...
        var o = t.effects.createWrapper(i).css({ overflow: "hidden" }),
    ...
    t.effects.bounce = function (e) {
      return this.queue(function () {
        ...
        var h = "up" == r || "down" == r ? "top" : "left",
          ...
          o =
            e.options.distance ||
            ("top" == h ? i.outerHeight(!0) / 3 : i.outerWidth(!0) / 3);
        if (
          ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -o : o),
          "hide" == n && (o /= 2 * a),
          "hide" != n && a--,
          "show" == n)
        ) {
        ...
        for (var d = 0; d < a; d++) {
          ...
          (p[h] = ("pos" == c ? "-=" : "+=") + o),
            (f[h] = ("pos" == c ? "+=" : "-=") + o),
            i
              .animate(p, l / 2, e.options.easing)
              .animate(f, l / 2, e.options.easing),
            (o = "hide" == n ? 2 * o : o / 2);
        }
        if ("hide" == n) {
          var u = { opacity: 0 };
          ...
          (p[h] = ("pos" == c ? "-=" : "+=") + o),
            ...
            i
              .animate(p, l / 2, e.options.easing)
              .animate(f, l / 2, e.options.easing, function () {
                t.effects.restore(i, s),
                  t.effects.removeWrapper(i),
                  e.callback && e.callback.apply(this, arguments);
              });
    ...
    t.effects.drop = function (e) {
      return this.queue(function () {
        ...
        var o = "up" == r || "down" == r ? "top" : "left",
          ...
          l =
            e.options.distance ||
            ("top" == o ? i.outerHeight(!0) / 2 : i.outerWidth(!0) / 2);
            ...
            n.clone()
              ...
              .css({
                ...
                left:
                  ...
                  h * (o / s) +
                  ("show" == e.options.mode
                    ? (h - Math.floor(s / 2)) * (o / s)
                    : 0),
                top:
                  r.top +
                  l * (a / i) +
                  ("show" == e.options.mode
                    ? (l - Math.floor(i / 2)) * (a / i)
                    : 0),
    ...
    t.effects.fold = function (e) {
      return this.queue(function () {
        ...
        d && (r = (parseInt(d[1], 10) / 100) * u["hide" == n ? 0 : 1]),
          "show" == n &&
            l.css(o ? { height: 0, width: r } : { height: r, width: 0 });
        var p = {},
          f = {};
        (p[c[0]] = "show" == n ? u[0] : r),
          (f[c[1]] = "show" == n ? u[1] : 0),
          l
            .animate(p, a, e.options.easing)
            .animate(f, a, e.options.easing, function () {
              "hide" == n && i.hide(),
                t.effects.restore(i, s),
                t.effects.removeWrapper(i),
                e.callback && e.callback.apply(i[0], arguments),
    ...
    t.effects.highlight = function (e) {
      return this.queue(function () {
        var i = t(this),
          ...
          r = { backgroundColor: i.css("backgroundColor") };
        "hide" == n && (r.opacity = 0),
          t.effects.save(i, s),
          i
            .show()
    ...
    t.effects.pulsate = function (e) {
      return this.queue(function () {
        var i = t(this),
          ...
          o = i.is(":visible"),
          a = 0;
        o || (i.css("opacity", 0).show(), (a = 1)),
          (("hide" == s && o) || ("show" == s && !o)) && n--;
        for (var l = 0; l < n; l++)
          i.animate({ opacity: a }, r, e.options.easing), (a = (a + 1) % 2);
        i.animate({ opacity: a }, r, e.options.easing, function () {
    ...
    (t.effects.puff = function (e) {
      return this.queue(function () {
        ...
        t.extend(e.options, {
          ...
          from: "hide" == s ? o : { height: o.height * r, width: o.width * r },
        }),
      ...
      (t.effects.scale = function (e) {
        return this.queue(function () {
          var i = t(this),
            ...
            n = t.effects.setMode(i, e.options.mode || "effect"),
            r =
              parseInt(e.options.percent, 10) ||
              (0 == parseInt(e.options.percent, 10)
                ? 0
                : "hide" == n
                ? 0
                : 100),
            ...
            a = e.options.origin;
          "effect" != n &&
            ((s.origin = a || ["middle", "center"]), (s.restore = !0));
          var l = { height: i.height(), width: i.width() };
          i.from =
            e.options.from || ("show" == n ? { height: 0, width: 0 } : l);
          var h = {
            y: "horizontal" != o ? r / 100 : 1,
            x: "vertical" != o ? r / 100 : 1,
          };
          (i.to = { height: l.height * h.y, width: l.width * h.x }),
            e.options.fade &&
      ...
      (t.effects.size = function (e) {
        return this.queue(function () {
          ...
          ("box" == u || "both" == u) &&
            ...
            ("content" == u || "both" == u) &&
              ((a = a.concat(["marginTop", "marginBottom"]).concat(o)),
              (l = l.concat(["marginLeft", "marginRight"])),
              (r = s.concat(a).concat(l)),
              i.find("*[width]").each(function () {
                var i = t(this);
                c && t.effects.save(i, r);
                var s = { height: i.height(), width: i.width() };
                (i.from = {
  ...
  (function (t, e) {
    t.effects.shake = function (e) {
      return this.queue(function () {
        ...
        i
          .animate(u, a, e.options.easing)
          .animate(c, a / 2, e.options.easing, function () {
            t.effects.restore(i, s),
              t.effects.removeWrapper(i),
              e.callback && e.callback.apply(this, arguments);
          }),
  ...
  (function (t, e) {
    t.effects.slide = function (e) {
      return this.queue(function () {
        ...
        t.effects.save(i, s),
          i.show(),
          t.effects.createWrapper(i).css({ overflow: "hidden" });
        var o = "up" == r || "down" == r ? "top" : "left",
          a = "up" == r || "left" == r ? "pos" : "neg",
          l =
            e.options.distance ||
            ("top" == o ? i.outerHeight(!0) : i.outerWidth(!0));
    ...
    t.effects.transfer = function (e) {
      return this.queue(function () {
        var i = t(this),
          ...
          o = i.offset(),
          a = t('<div class="ui-effects-transfer"></div>')
    ...
    t.widget("ui.accordion", {
      ...
      _create: function () {
        ...
        if (
          ...
          if (s.length) {
            ...
            n.length
              ? (e.active = n)
              : (e.active = s.closest(".ui-accordion-content").prev());
          }
        }
        (e.active = e
      ...
      _createIcons: function () {
        ...
        e.icons &&
          ...
          this.active
            .children(".ui-icon")
            .toggleClass(e.icons.header)
            .toggleClass(e.icons.headerSelected),
      ...
      destroy: function () {
        ...
        return (
          (e.autoHeight || e.fillHeight) && i.css("height", ""),
          t.Widget.prototype.destroy.call(this)
        );
      },
      _setOption: function (e, i) {
      ...
      _findActive: function (e) {
        return e
          ? "number" == typeof e
            ? this.headers.filter(":eq(" + e + ")")
            : this.headers.not(this.headers.not(e))
          : !1 === e
          ? t([])
      ...
      _clickHandler: function (e, i) {
        ...
        if (!s.disabled) {
          ...
          var a = t(e.currentTarget || i),
            l = a[0] === this.active[0];
          if (
            ((s.active = (!s.collapsible || !l) && this.headers.index(a)),
      ...
      _toggle: function (e, i, s, n, r) {
        ...
        if (
          ...
          (h =
            ...
            (a.duration = t.isFunction(a.proxiedDuration)
              ? a.proxiedDuration(h)
              : a.proxiedDuration);
            ...
            (s = h[0].style.width),
              h.width(
                h.parent().width() -
                  ...
                  (parseFloat(h.css("borderLeftWidth")) || 0) -
                  (parseFloat(h.css("borderRightWidth")) || 0)
              ),
              t.each(l, function (i, s) {
                a[s] = "hide";
                var n = ("" + t.css(e.toShow[0], s)).match(/^([\d+-.]+)(.*)$/);
                o[s] = { value: n[1], unit: n[2] || "px" };
              }),
                ...
                .animate(a, {
                  step: function (t, i) {
                    "height" == i.prop &&
                      ...
                      (e.toShow[0].style[i.prop] =
                        r * o[i.prop].value + o[i.prop].unit);
                  },
                  duration: e.duration,
                  easing: e.easing,
                  complete: function () {
                    e.autoHeight || e.toShow.css("height", ""),
                      e.toShow.css({ width: s, overflow: n }),
                      e.complete();
                  },
                });
          },
    ...
    t.widget("ui.autocomplete", {
      ...
      search: function (t, e) {
        ...
        t.length < this.options.minLength)
          ? this.close(e)
          : (clearTimeout(this.closing), !1 !== this._trigger("search", e))
          ? this._search(t)
          : void 0;
      },
      _search: function (t) {
      ...
      activate: function (t, e) {
        if ((this.deactivate(), this.hasScroll())) {
          ...
          i < 0
            ...
            : i >= n && this.element.scrollTop(s + i - n + e.height());
        }
        (this.active = e
          .eq(0)
          .children("a")
    ...
    t.widget("ui.button", {
      ...
      _resetButton: function () {
        ...
        var e = this.buttonElement.removeClass(l),
          i = t("<span></span>", this.element[0].ownerDocument)
        ...
        s.primary || s.secondary
          ? (this.options.text &&
            ...
            this.options.text ||
              (r.push(n ? "ui-button-icons-only" : "ui-button-icon-only"),
  ...
  (function ($, undefined) {
      ...
      return t
        ...
        .bind("mouseover", function (i) {
          ...
          !$.datepicker._isDisabledDatepicker(
            ...
            s.hasClass("ui-datepicker-prev") &&
              s.addClass("ui-datepicker-prev-hover"),
            s.hasClass("ui-datepicker-next") &&
              s.addClass("ui-datepicker-next-hover"));
        });
    }
    ...
    $.extend(Datepicker.prototype, {
          ...
          (e.trigger = $(
            this._get(e, "buttonImageOnly")
              ...
              : $('<button type="button"></button>')
                  .addClass(this._triggerClass)
                  .html(
                    "" == o ? r : $("<img/>").attr({ src: o, alt: r, title: r })
                  )
          )),
      ...
      _autoSize: function (t) {
        if (this._get(t, "autoSize") && !t.inline) {
          ...
          if (i.match(/[DM]/)) {
            ...
            e.setMonth(
              s(this._get(t, i.match(/MM/) ? "monthNames" : "monthNamesShort"))
            ),
              e.setDate(
                s(this._get(t, i.match(/DD/) ? "dayNames" : "dayNamesShort")) +
                  20 -
                  e.getDay()
              );
          }
        ...
        if ($.datepicker._get(e, "constrainInput")) {
          var i = $.datepicker._possibleChars(
            ...
            s = String.fromCharCode(
              undefined == t.charCode ? t.keyCode : t.charCode
            );
          ...
          if (!1 !== s) {
            ...
            if (
              ...
              e.dpDiv.zIndex($(t).zIndex() + 1),
                ...
                $.effects && $.effects[o]
                  ? e.dpDiv.show(o, $.datepicker._get(e, "showOptions"), a, l)
                  : e.dpDiv[o || "show"](o ? a : null, l),
                (o && a) || l(),
                e.input.is(":visible") &&
                  !e.input.is(":disabled") &&
                  e.input.focus(),
      ...
      _checkOffset: function (t, e, i) {
        ...
        return (
          (e.left -= this._get(t, "isRTL") ? s - r : 0),
          (e.left -=
          ...
          (e.left -= Math.min(
            e.left,
            e.left + s > a && a > s ? Math.abs(e.left + s - a) : 0
          )),
          (e.top -= Math.min(
            e.top,
            e.top + n > l && l > n ? Math.abs(n + o) : 0
          )),
          e
        );
      },
      ...
      _hideDatepicker: function (t) {
        ...
        if (e && (!t || e == $.data(t, PROP_NAME)) && this._datepickerShowing) {
          ...
          r &&
            r.apply(e.input ? e.input[0] : null, [
              e.input ? e.input.val() : "",
              e,
            ]),
      ...
      _setDate: function (t, e, i) {
        ...
        (t.selectedDay = t.currentDay = o.getDate()),
          ...
          (n == t.selectedMonth && r == t.selectedYear) ||
            i ||
      ...
      _generateHTML: function (t) {
        ...
        if ((p < 0 && ((p += 12), f--), d)) {
          ...
          for (
            g = u && g < u ? u : g;
            this._daylightSavingAdjust(new Date(f, p, 1)) > g;
        ...
        for (
          ...
          for (var N = 0; N < o[1]; N++) {
            var H = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
              ...
              R = "";
            if (h) {
              if (((R += '<div class="ui-datepicker-group'), o[1] > 1))
                switch (N) {
                  case 0:
            ...
            R +=
              ...
              W +
              '">' +
              (/all|left/.test(W) && 0 == O ? (i ? y : v) : "") +
              (/all|right/.test(W) && 0 == O ? (i ? v : y) : "") +
            ...
            this.maxRows = U;
            for (
              var X = this._daylightSavingAdjust(new Date(f, p, 1 - V)), Q = 0;
              Q < U;
              Q++
            ) {
              R += "<tr>";
              for (
                ...
                var G = P
                    ? P.apply(t.input ? t.input[0] : null, [X])
                    : [!0, ""],
                  J = X.getMonth() != p,
                  tt = (J && !T) || !G[0] || (u && X < u) || (d && X > d);
                (Z +=
                  '<td class="' +
                  ((j + k + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") +
                  (J ? " ui-datepicker-other-month" : "") +
                  ((X.getTime() == H.getTime() &&
                    p == t.selectedMonth &&
                    t._keyEvent) ||
                  (z.getTime() == X.getTime() && z.getTime() == H.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (tt
                  ...
                  (J && !I
                    ...
                    : '<a class="ui-state-default' +
                      (X.getTime() == e.getTime()
                        ? " ui-state-highlight"
                        : "") +
                      (X.getTime() == c.getTime() ? " ui-state-active" : "") +
        ...
        return (
          (M +=
            C +
            ($.browser.msie && 7 > parseInt($.browser.version, 10) && !t.inline
      ...
      _adjustInstDate: function (t, e, i) {
        var s = t.drawYear + ("Y" == i ? e : 0),
          ...
          o = this._restrictMinMax(
            t,
            this._daylightSavingAdjust(new Date(s, n, r))
          );
    ...
    t.widget("ui.dialog", {
      ...
      _create: function () {
        ...
        var e = this,
          ...
          o = (e.uiDialog = t("<div></div>"))
            ...
            .keydown(function (i) {
              s.closeOnEscape &&
                !i.isDefaultPrevented() &&
                i.keyCode &&
                i.keyCode === t.ui.keyCode.ESCAPE &&
                (e.close(i), i.preventDefault());
            })
            .attr({ role: "dialog", "aria-labelledby": r })
          ...
          l = t('<a href="#"></a>')
            ...
            .appendTo(a);
        (e.uiDialogTitlebarCloseText = t("<span></span>"))
          ...
          t("<span></span>")
            ...
            .html(n)
            .prependTo(a),
          t.isFunction(s.beforeclose) &&
            !t.isFunction(s.beforeClose) &&
            (s.beforeClose = s.beforeclose),
      ...
      moveToTop: function (e, i) {
        var s,
          n = this,
          r = n.options;
        return (!r.modal || e) && (r.stack || r.modal)
          ? (r.zIndex > t.ui.dialog.maxZ && (t.ui.dialog.maxZ = r.zIndex),
            n.overlay &&
              ((t.ui.dialog.maxZ += 1),
              n.overlay.$el.css(
                "z-index",
                (t.ui.dialog.overlay.maxZ = t.ui.dialog.maxZ)
              )),
            (s = {
      ...
      _makeDraggable: function () {
        ...
        s.uiDialog.draggable({
          ...
          stop: function (o, a) {
            (n.position = [
              a.position.left - r.scrollLeft(),
              a.position.top - r.scrollTop(),
            ]),
      ...
      _position: function (e) {
        ...
        e
          ? (("string" == typeof e || ("object" == typeof e && "0" in e)) &&
              (1 === (s = e.split ? e.split(" ") : [e[0], e[1]]).length &&
                (s[1] = s[0]),
      ...
      _setOption: function (e, s) {
        ...
        switch (e) {
          ...
          case "disabled":
            s
              ? r.addClass("ui-dialog-disabled")
              : r.removeClass("ui-dialog-disabled");
            break;
          case "draggable":
          ...
          case "resizable":
            ...
            break;
          case "title":
            t(".ui-dialog-title", n.uiDialogTitlebar).html(
              "" + (s || "&#160;")
            );
        }
      ...
      t.extend(t.ui.dialog, {
        ...
        getTitleId: function (t) {
          var e = t.attr("id");
          return (
            e || ((this.uuid += 1), (e = this.uuid)), "ui-dialog-title-" + e
          );
        },
        overlay: function (e) {
      ...
      t.extend(t.ui.dialog.overlay, {
        ...
        create: function (e) {
          ...
          var i = (
            ...
            t("<div></div>").addClass("ui-widget-overlay")
          )
            .appendTo(document.body)
        ...
        destroy: function (e) {
          ...
          -1 != i && this.oldInstances.push(this.instances.splice(i, 1)[0]),
            0 === this.instances.length &&
              t([document, window]).unbind(".dialog-overlay"),
            e.remove();
          var s = 0;
  ...
  (function (t, e) {
    ...
    (t.fn.position = function (e) {
      ...
      return (
        9 === u.nodeType
          ? ((a = c.width()), (l = c.height()), (h = { top: 0, left: 0 }))
          : u.setTimeout
          ? ((a = c.width()),
            (l = c.height()),
            (h = { top: c.scrollTop(), left: c.scrollLeft() }))
          : u.preventDefault
          ? ((e.at = "left top"),
            (a = l = 0),
            (h = { top: e.of.pageY, left: e.of.pageX }))
          : ((a = c.outerWidth()), (l = c.outerHeight()), (h = c.offset())),
        ...
        this.each(function () {
          ...
          "right" === e.my[0]
            ...
            "bottom" === e.my[1]
              ...
              : e.my[1] === n && (v.top -= c / 2),
            r.fractions ||
              ((v.left = Math.round(v.left)), (v.top = Math.round(v.top))),
            (i = { left: v.left - u, top: v.top - f }),
            t.each(["left", "top"], function (s, n) {
              t.ui.position[d[s]] &&
                t.ui.position[d[s]][n](v, {
                  targetWidth: a,
                  targetHeight: l,
                  elemWidth: o,
                  elemHeight: c,
          ...
          top: function (e, i) {
            if (i.at[1] !== n) {
              var s = t(window),
                ...
                l = -2 * i.offset[1];
              e.top +=
                i.collisionPosition.top < 0 ? o + a + l : r > 0 ? o + a + l : 0;
            }
          },
        },
      }),
      t.offset.setOffset ||
        ((t.offset.setOffset = function (e, i) {
          ...
          var s = t(e),
            ...
            a = { top: i.top - n.top + r, left: i.left - n.left + o };
        ...
        (this._keySliding = !1),
          ...
          this.element.addClass(
            "ui-slider ui-slider-" +
              ...
              (s.disabled ? " ui-slider-disabled ui-disabled" : "")
          ),
          (this.range = t([])),
          s.range &&
            (!0 === s.range &&
              (s.values || (s.values = [this._valueMin(), this._valueMin()]),
              s.values.length &&
                2 !== s.values.length &&
                (s.values = [s.values[0], s.values[0]])),
            (this.range = t("<div></div>")
              .appendTo(this.element)
              .addClass(
                "ui-slider-range ui-widget-header" +
                  ("min" === s.range || "max" === s.range
                    ? " ui-slider-range-" + s.range
                    : "")
              )));
          ...
          this.handles
            .keydown(function (s) {
              var n,
                ...
                o,
                a,
                l = t(this).data("index.ui-slider-handle");
      ...
      values: function (e, i) {
        ...
        if (!t.isArray(arguments[0]))
          return this.options.values && this.options.values.length
            ...
            : this.value();
        for (
          s = this.options.values, n = arguments[0], r = 0;
          r < s.length;
          r += 1
        )
          (s[r] = this._trimAlignValue(n[r])), this._change(null, r);
        this._refreshValue();
      },
      _setOption: function (e, i) {
        var s,
        ...
        this.options.values && this.options.values.length
                ...
                !0 === l.options.range &&
                  ("horizontal" === l.orientation
                    ? (0 === s &&
                        l.range
                          .stop(1, 1)
                          [h ? "animate" : "css"]({ left: e + "%" }, a.animate),
                      1 === s &&
          ...
          : ((s = this.value()),
            ...
            "min" === o &&
              ...
              this.range
                .stop(1, 1)
                [h ? "animate" : "css"]({ width: e + "%" }, a.animate),
            "max" === o &&
              "horizontal" === this.orientation &&
            ...
            "min" === o &&
              ...
              this.range
                .stop(1, 1)
                [h ? "animate" : "css"]({ height: e + "%" }, a.animate),
            "max" === o &&
              "vertical" === this.orientation &&
              this.range[h ? "animate" : "css"](
                { height: 100 - e + "%" },
    ...
    t.widget("ui.tabs", {
      ...
      _setOption: function (t, e) {
        "selected" == t
          ? (this.options.collapsible && e == this.options.selected) ||
            this.select(e)
          : ((this.options[t] = e), this._tabify());
      },
      _tabId: function (t) {
        return (
          (t.title &&
            t.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "")) ||
      ...
      _tabify: function (i) {
        ...
        (this.list = this.element.find("ol,ul").eq(0)),
            ...
            if (
              ...
              c.length ||
                (c = t(a.panelTemplate)
                  ...
                  .insertAfter(o.panels[e - 1] || o.list)).data(
                  "destroy.tabs",
                  !0
                ),
            ...
            ? (this.element.addClass(
              ...
              a.selected === e
                ? (location.hash &&
                  ...
                  "number" != typeof a.selected &&
                    a.cookie &&
                    (a.selected = parseInt(o._cookie(), 10)),
                  "number" != typeof a.selected &&
                    this.lis.filter(".ui-tabs-selected").length &&
                    (a.selected = this.lis.index(
                      this.lis.filter(".ui-tabs-selected")
                    )),
                  (a.selected = a.selected || (this.lis.length ? 0 : -1)))
                : null === a.selected && (a.selected = -1),
              (a.selected =
                (a.selected >= 0 && this.anchors[a.selected]) || a.selected < 0
                  ? a.selected
                  : 0),
              (a.disabled = t
                .unique(
                ...
                .sort()),
              -1 != t.inArray(a.selected, a.disabled) &&
                a.disabled.splice(t.inArray(a.selected, a.disabled), 1),
              this.panels.addClass("ui-tabs-hide"),
              this.lis.removeClass("ui-tabs-selected ui-state-active"),
              a.selected >= 0 &&
                this.anchors.length &&
                (o.element
                  .find(o._sanitizeSelector(o.anchors[a.selected].hash))
                ...
                o.element.queue("tabs", function () {
                  o._trigger(
                    ...
                    null,
                    o._ui(
                      o.anchors[a.selected],
                      o.element.find(
                        o._sanitizeSelector(o.anchors[a.selected].hash)
                      )[0]
                    )
                  );
                }),
          ...
          this.element[a.collapsible ? "addClass" : "removeClass"](
            "ui-tabs-collapsible"
          ),
          a.cookie && this._cookie(a.selected, a.cookie);
        for (var h, c = 0; (h = this.lis[c]); c++)
          t(h)[
            -1 == t.inArray(c, a.disabled) || t(h).hasClass("ui-tabs-selected")
              ? "removeClass"
              : "addClass"
          ]("ui-state-disabled");
        if (
          (!1 === a.cache && this.anchors.removeData("cache.tabs"),
        ...
        a.fx &&
          (t.isArray(a.fx) ? ((n = a.fx[0]), (r = a.fx[1])) : (n = r = a.fx));
        var p = r
            ? function (e, i) {
        ...
        this.anchors.bind(a.event + ".tabs", function () {
          ...
          if (
            (i.hasClass("ui-tabs-selected") && !a.collapsible) ||
            i.hasClass("ui-state-disabled") ||
            i.hasClass("ui-state-processing") ||
            o.panels.filter(":animated").length ||
            !1 === o._trigger("select", null, o._ui(this, n[0]))
          )
            return this.blur(), !1;
          if (
            ((a.selected = o.anchors.index(this)), o.abort(), a.collapsible)
          ) {
          ...
          if ((a.cookie && o._cookie(a.selected, a.cookie), n.length))
            s.length &&
              o.element.queue("tabs", function () {
                f(e, s);
              }),
      ...
      add: function (i, s, n) {
        ...
        var r = this,
          o = this.options,
          a = t(
            o.tabTemplate.replace(/#\{href\}/g, i).replace(/#\{label\}/g, s)
          ),
        ...
        return (
          h.length ||
            (h = t(o.panelTemplate).attr("id", l).data("destroy.tabs", !0)),
          h.addClass(
            "ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"
          ),
          n >= this.lis.length
            ? (a.appendTo(this.list), h.appendTo(this.list[0].parentNode))
            : (a.insertBefore(this.lis[n]), h.insertBefore(this.panels[n])),
      ...
      disable: function (t) {
        ...
        return (
          t != e.selected &&
            (this.lis.eq(t).addClass("ui-state-disabled"),
            e.disabled.push(t),
            e.disabled.sort(),
            this._trigger(
              "disable",
      ...
      url: function (t, e) {
        return (
          this.anchors.eq(t).removeData("cache.tabs").data("load.tabs", e), this
        );
      },
      length: function () {
    ...
    t.each("branch form header step wrapper".split(" "), function () {
      ...
      t.widget("kf." + c, {
        ...
        _create: function () {
          ...
          p[0].elements
            ? (e = p)
            : (e = p.find(l)).length || (e = p.closest(l)),
          ...
          t.isFunction(s) && ((n = s), (s = e)),
            (function e() {
              o._transition(a, function (h, c) {
                ...
                if (t.inArray(a, l) >= 0)
                  throw Error(
                    '[_fastForward]: Recursion detected on step "' + h + '"'
                  );
                l.push(a),
                  a === o._lastStepIndex || (s ? ++r : a) === i
                    ? n.call(o, a, l)
                    : e();
              });
            })();
        ...
        _move: function (i, s, n, r, o) {
          ...
          typeof s === g && ((o = r), (r = n), (n = s), (s = e)),
            !0 === n
              ? i > 0
                ? a._fastForward(i, n, h)
                : o.call(
                    a,
                    l.stepsActivated[
                      Math.max(0, i + (l.stepsActivated.length - 1))
                    ]
                  )
              : -1 !== (i = a.stepIndex(i, s)) &&
                (i > l.stepIndex ? a._fastForward(i, h) : h.call(a, i));
        },
        _state: function (e, i) {
          ...
          for (var r, a, l, h = 0, c = i.length; h < c; h++)
            (e = i[h]),
              ...
              !n.stepIndex || n.stepIndex < e
                ? 0 > t.inArray(e, n.stepsActivated) &&
                  (n.stepsActivated.push(e),
                  0 > t.inArray(r, n.branchesActivated) &&
                    n.branchesActivated.push(r))
                : n.stepIndex > e &&
                  ((a = t.inArray(r, n.branchesActivated) + 1),
                  (l = t.inArray(e, n.stepsActivated) + 1),
                  a > 0 &&
                    n.branchesActivated.splice(
                      a,
                      n.branchesActivated.length - 1
                    ),
                  l > 0 &&
                    n.stepsActivated.splice(l, n.stepsActivated.length - 1)),
              (n.stepIndex = e),
              (n.branchLabel = r);
          return (
            (n.stepsComplete = Math.max(
              0,
              this._find(n.stepsActivated, this.elements.steps).filter(
                this._excludesFilter
              ).length - 1
            )),
            (n.stepsPossible = Math.max(
              0,
              this._find(n.branchesActivated, this.elements.branches)
                .children(s.step)
        ...
        _transition: function (i, s, n) {
          var a = this;
          t.isFunction(i)
            ? ((n = i), (i = a._currentState.stepIndex), (s = e))
            : t.isFunction(s) && ((n = s), (s = e));
          var l,
            h = a.options,
            c = a.step(i, s),
        ...
        _update: function (e, i) {
          ...
          if (s.step) {
            if (
              ...
              !this._trigger(x, e, i) ||
              (i.isMovingForward && !this._trigger(_, e, i)) ||
              (!i.isMovingForward && !this._trigger(y, e, i))
            )
              return;
            s.step
              .removeClass(n.stepClasses.current)
              .animate(
                n.animations.hide.properties,
                t.extend({}, n.animations.hide.options)
              );
          }
          (this._currentState = i),
            i.step
              .addClass(n.stepClasses.current)
              .animate(
                n.animations.show.properties,
                t.extend({}, n.animations.show.options)
              ),
            i.isFirstStep ||
            n.unidirectional ||
            i.step.hasClass(n.stepClasses.unidirectional)
              ? this.elements.backward.attr(h, !0)
              : this.elements.backward.removeAttr(h),
            (i.isLastStepInBranch && !i.step.attr(n.stateAttribute)) ||
            i.step.hasClass(n.stepClasses.stop)
              ? this.elements.forward.attr(h, !0)
              : this.elements.forward.removeAttr(h),
            n.enableSubmit || i.step.hasClass(n.stepClasses.submit)
              ? this.elements.submit.removeAttr(h)
              : this.elements.submit.attr(h, !0),
            s.step &&
              (this._trigger($, e, i),
        ...
        branch: function (t) {
          return arguments.length
            ? this._find(t, this.elements.branches)
            : this._currentState.branch;
        },
        branches: function (t) {
          return arguments.length
            ? this.branch(t).children(s.branch)
        ...
        destroy: function () {
          var e = this.elements;
          this._trigger(w, null, this.state()) &&
        ...
        select: function (i, s, n, r, o) {
          i instanceof t.Event || ((o = r), (r = n), (n = s), (s = i), (i = e)),
            s !== e &&
              (t.isArray(s)
                ? ((o = r), (r = n), (n = s[1]), (s = s[0]))
                : typeof n === g
        ...
        state: function (i, s, n) {
          return arguments.length
            ? (t.isArray(i)
                ? ((n = s), (s = i[1]), (i = i[0]))
                : t.isArray(s) && ((n = s), (s = e)),
              this._state(this.stepIndex(i, s), n))
            : this._currentState;
        },
        step: function (i, s) {
          var r;
          return arguments.length
            ? (t.isArray(i) && ((s = i[1]), (i = i[0])),
              typeof i === d
                ? (r = this._find(
                    i,
                    s !== e ? this.steps(s) : this.elements.steps
                  ))
                : (r = this._find(
                    i,
          ...
          i ||
            ...
            i.settings.onsubmit &&
              ...
              this.submit(function (e) {
                ...
                return (i.settings.debug && e.preventDefault(), i.cancelSubmit)
                  ? ((i.cancelSubmit = !1), s())
                  : i.form()
                  ? i.pendingRequest
                    ? ((i.formSubmitted = !0), !1)
      ...
      t.extend(t.validator, {
        ...
        prototype: {
          ...
          check: function (e) {
            ...
            for (var o in s) {
              var a = { method: o, parameters: s[o] };
              try {
                if (
                  ((i = t.validator.methods[o].call(this, r, e, a.parameters)),
        ...
        attributeRules: function (e) {
          ...
          for (var o in t.validator.methods)
            "required" === o
              ? ("" === (i = n.get(0).getAttribute(o)) && (i = !0), (i = !!i))
              : (i = n.attr(o)),
              /min|max/.test(o) &&
  ...
  (function (t) {
    ...
    if (t.ajaxPrefilter)
      ...
      t.ajax = function (s) {
        ...
        return "abort" === n
          ? (e[r] && e[r].abort(), (e[r] = i.apply(this, arguments)), e[r])
    ...
    (s.prototype = {
      ...
      build_: function (t) {
        ...
        i &&
          ...
          "function" == typeof e.config_[e.current_].customEvent &&
            e.config_[e.current_].customEvent.call(e, t));
      },
      ...
      getLabel_: function (t) {
        ...
        return (
          i.length > 1 && (i = t.parentNode.querySelectorAll(e)),
          1 === i.length && i[0]
        );
      },
      getLabelText_: function (t, e) {
        ...
        return (
          (!i ||
            (i &&
              s &&
              "placeholder" === this.config_[this.current_].prioritize)) &&
            (i = s),
          i
        );
      },
      ...
      isValidField_: function (t) {
        var e =
            "INPUT" === t.tagName &&
            !this.config_[this.current_].inputRegex.test(
              t.getAttribute("type")
            ),
        ...
        for (var i = this, s = 0; s < i.el_.length; ++s) {
          if (void 0 === i.selectors_[s]) {
            var n = i.extend_(
                ...
                i.defaults_,
                i.options_,
                i.el_[s].getAttribute("data-options")
              ),
      ...
      onInput_: function (t) {
        t.target.parentNode.classList[this.addRemove_(t.target.value.length)](
      ...
      resetFields_: function () {
        for (
          var t = this,
            e = t.el_[t.current_].querySelectorAll(t.selectors_[t.current_]),
            i = 0;
          i < e.length;
          ++i
        )
          e[i].parentNode.classList[
            t.addRemove_("SELECT" === e[i].tagName && "" !== e[i].value)
          ](t.prefixed_("is-active"));
      },
      ...
      setLabel_: function (t, e) {
        ...
        t.classList.add(i.prefixed_("label")),
          ...
          "function" == typeof i.config_[i.current_].customLabel &&
            (t.textContent = i.config_[i.current_].customLabel.call(i, t, e));
      },
      setPlaceholder_: function (t, e) {
        var i = this,
          s = e.getAttribute("placeholder");
        ("label" !== i.config_[i.current_].prioritize && s) ||
          (s && e.setAttribute("data-placeholder", s),
          (s = i.getLabelText_(t, e))),
          "function" == typeof i.config_[i.current_].customPlaceholder &&
            (s = i.config_[i.current_].customPlaceholder.call(i, s, e, t)),
          "SELECT" === e.tagName
            ? i.setSelectPlaceholder_(e, s)
            : e.setAttribute("placeholder", s);
      },
      setSelectPlaceholder_: function (t, e) {
        var i = t.firstElementChild;
        i.hasAttribute("value") && i.value
          ? (t.insertBefore(new Option(e, ""), i),
            !1 === t.options[t.selectedIndex].defaultSelected &&
              (t.selectedIndex = 0))
        ...
        var i = this,
          s = i.createEl_("div", {
            class:
              i.prefixed_("wrap") +
              " " +
              i.prefixed_("wrap-" + e.tagName.toLowerCase()),
          });
        void 0 !== e.value &&
          e.value.length &&
          s.classList.add(i.prefixed_("is-active")),
          (null !== e.getAttribute("required") ||
            e.classList.contains(i.config_[i.current_].requiredClass)) &&
            s.classList.add(i.prefixed_("is-required")),
